...
class PercentShadedAreaService:
    @classmethod
    def calculate_by_plant_canopy_projection(
        cls, input_entity: PlantCanopyProjectionInputEntity
    ) -> Decimal:
    ...
    @classmethod
    def calculate_by_plant_strip_projection(
        cls, input_entity: PlantStripProjectionInputEntity
    ) -> Decimal:
