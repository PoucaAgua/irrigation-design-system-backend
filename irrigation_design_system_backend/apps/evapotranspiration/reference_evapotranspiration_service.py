...
from core.domain.entity.evapotranspiration_entity import EToEntity, EToHargravesSamaniInputyEntity, EToPenmanMonteithInputyEntity,EToBlanneyCriddleInputyEntity
import pandas as pd
