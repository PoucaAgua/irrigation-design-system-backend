...
from apps.evapotranspiration.funcitions_to_reference_evapotranspiration import calculate_temperature_media, calculate_radiation_hargreaves_samani #, calculate_radiation_hargreaves_samani, calculate_radiation_blaney_criddle, calculate_vapor_saturation_pressure, calculate_vapor_current_pressure, calculate_declivity_curve_pressure_vapor, calculate_atmospheric_pressure, calculate_psychrometric_constant)
# from apps.evapotranspiration.function_calculate_hargreaves_samani import calculate_radiation_hargreaves_samani
# from apps.evapotranspiration.funcition_calculate__blaney_criddle import calculate_radiation_blaney_criddle
# from apps.evapotranspiration.function_calculate_penman_monteith import calculate_vapor_saturation_pressure, calculate_vapor_current_pressure, calculate_declivity_curve_pressure_vapor, calculate_atmospheric_pressure, calculate_psychrometric_constant
