...
def create_crop_coefficient(
    crop_coefficient: CropCoefficientEntity,
    db: Session = Depends(get_db)
):
    crop_coefficient_repository = CropCoefficientRepository(db)
    db_crop_coefficient = crop_coefficient_repository.create_crop_coefficient(
...
@router.put("/crop_coefficients/{crop_coefficient_id}/", response_model=CropCoefficientUpdateResponse)
...
@router.delete("/crop_coefficients/{crop_coefficient_id}/", response_model=CropCoefficientDeleteResponse)
